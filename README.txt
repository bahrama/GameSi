...
a persistence unit "GameSiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "GameSi/pom.xml":
...
artifacts ("GameSi-ejb.jar" and "GameSi-web.war") are already built. You can build
